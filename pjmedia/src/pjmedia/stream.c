...
PJ_INLINE(int)
trace_jb_print_timestamp(char **buf, pj_ssize_t len)
{
	pj_time_val now;
...
PJ_INLINE(int)
trace_jb_print_state(pjmedia_stream *stream,
																	 ...
																	 void *user_data)
{
	...
	{
		pjmedia_event_rx_rtcp_fb_data *data = (pjmedia_event_rx_rtcp_fb_data *)&event->data.rx_rtcp_fb;
