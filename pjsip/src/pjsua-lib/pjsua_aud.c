 ...
 */
PJ_DEF(pj_bool_t)
pjsua_call_has_media(pjsua_call_id call_id)
{
...
pjsua_call_get_conf_port(pjsua_call_id call_id)
{
    pjsua_call *call;
 ...
 */
PJ_DEF(pj_status_t)
pjsua_call_get_stream_info(pjsua_call_id call_id,
                           unsigned med_idx,
 ...
 */
PJ_DEF(pj_status_t)
pjsua_call_get_stream_stat(pjsua_call_id call_id,
                           unsigned med_idx,
 ...
 */
PJ_DEF(pj_status_t)
pjsua_call_dial_dtmf(pjsua_call_id call_id,
...
PJ_DEF(void)
pjsua_snd_dev_param_default(pjsua_snd_dev_param *prm)
{
...
PJ_DEF(void)
pjsua_conf_connect_param_default(pjsua_conf_connect_param *prm)
{
    pj_bzero(prm, sizeof(*prm));
    prm->level = 1.0;
}
 ...
 */
PJ_DEF(unsigned)
pjsua_conf_get_active_ports(void)
{
 ...
 */
PJ_DEF(pj_status_t)
pjsua_enum_conf_ports(pjsua_conf_port_id id[],
                      unsigned *count)
{
 ...
 */
PJ_DEF(pj_status_t)
pjsua_conf_get_port_info(pjsua_conf_port_id id,
 ...
 */
PJ_DEF(pj_status_t)
pjsua_conf_add_port(pj_pool_t *pool,
                    pjmedia_port *port,
 ...
 */
PJ_DEF(pj_status_t)
pjsua_conf_remove_port(pjsua_conf_port_id id)
{
    pj_status_t status;
 ...
 */
PJ_DEF(pj_status_t)
pjsua_conf_connect(pjsua_conf_port_id source,
 ...
 */
PJ_DEF(pj_status_t)
pjsua_conf_connect2(pjsua_conf_port_id source,
                    pjsua_conf_port_id sink,
 ...
 */
PJ_DEF(pj_status_t)
pjsua_conf_adjust_tx_level(pjsua_conf_port_id slot,
                           float level)
{
 ...
 */
PJ_DEF(pj_status_t)
pjsua_conf_adjust_rx_level(pjsua_conf_port_id slot,
                           float level)
{
 ...
 */
PJ_DEF(pj_status_t)
pjsua_conf_get_signal_level(pjsua_conf_port_id slot,
                            unsigned *tx_level,
                            unsigned *rx_level)
{
 ...
 */
PJ_DEF(pj_status_t)
pjsua_player_create(const pj_str_t *filename,
                    unsigned options,
 ...
 */
PJ_DEF(pj_status_t)
pjsua_playlist_create(const pj_str_t file_names[],
                      unsigned file_count,
 ...
 */
PJ_DEF(pj_status_t)
pjsua_player_get_port(pjsua_player_id id,
                      pjmedia_port **p_port)
{
    PJ_ASSERT_RETURN(id >= 0 && id < (int)PJ_ARRAY_SIZE(pjsua_var.player), PJ_EINVAL);
    PJ_ASSERT_RETURN(pjsua_var.player[id].port != NULL, PJ_EINVAL);
 ...
 */
PJ_DEF(pj_status_t)
pjsua_player_get_info(pjsua_player_id id,
 ...
 */
PJ_DEF(pj_status_t)
pjsua_player_set_pos(pjsua_player_id id,
                     pj_uint32_t samples)
{
    pjmedia_wav_player_info info;
 ...
 */
PJ_DEF(pj_status_t)
pjsua_player_destroy(pjsua_player_id id)
{
    PJ_ASSERT_RETURN(id >= 0 && id < (int)PJ_ARRAY_SIZE(pjsua_var.player), PJ_EINVAL);
    PJ_ASSERT_RETURN(pjsua_var.player[id].port != NULL, PJ_EINVAL);
 ...
 */
PJ_DEF(pj_status_t)
pjsua_recorder_create(const pj_str_t *filename,
                      unsigned enc_type,
                      void *enc_param,
                      pj_ssize_t max_size,
                      unsigned options,
 ...
 */
PJ_DEF(pjsua_conf_port_id)
pjsua_recorder_get_conf_port(pjsua_recorder_id id)
{
 ...
 */
PJ_DEF(pj_status_t)
pjsua_recorder_get_port(pjsua_recorder_id id,
                        pjmedia_port **p_port)
{
    PJ_ASSERT_RETURN(id >= 0 && id < (int)PJ_ARRAY_SIZE(pjsua_var.recorder),
                     PJ_EINVAL);
 ...
 */
PJ_DEF(pj_status_t)
pjsua_recorder_destroy(pjsua_recorder_id id)
{
    PJ_ASSERT_RETURN(id >= 0 && id < (int)PJ_ARRAY_SIZE(pjsua_var.recorder),
                     PJ_EINVAL);
    PJ_ASSERT_RETURN(pjsua_var.recorder[id].port != NULL, PJ_EINVAL);
...
PJ_DEF(pj_status_t)
pjsua_enum_aud_devs(pjmedia_aud_dev_info info[],
                    unsigned *count)
{
...
PJ_DEF(pj_status_t)
pjsua_enum_snd_devs(pjmedia_snd_dev_info info[],
                    unsigned *count)
{
    unsigned i, dev_count;
                                    ...
                                    unsigned bits_per_sample)
{
    ...
    status = pjmedia_aud_dev_default_param((speaker_only ? playback_dev : capture_dev), param);
    if (status != PJ_SUCCESS)
    {
...
PJ_DEF(pj_status_t)
pjsua_set_snd_dev(int capture_dev,
                  int playback_dev)
{
 ...
 */
PJ_DEF(pj_status_t)
pjsua_set_snd_dev2(pjsua_snd_dev_param *snd_param)
{
 ...
 */
PJ_DEF(pj_status_t)
pjsua_get_snd_dev(int *capture_dev,
                  int *playback_dev)
{
    PJSUA_LOCK();
 ...
 */
PJ_DEF(pj_status_t)
pjsua_set_ec(unsigned tail_ms, unsigned options)
{
    pj_status_t status = PJ_SUCCESS;
 ...
 */
PJ_DEF(pj_status_t)
pjsua_get_ec_tail(unsigned *p_tail_ms)
{
 ...
 */
PJ_DEF(pj_status_t)
pjsua_get_ec_stat(pjmedia_echo_stat *p_stat)
{
    if (pjsua_var.snd_port)
    {
 ...
 */
PJ_DEF(pj_status_t)
pjsua_snd_set_setting(pjmedia_aud_dev_cap cap,
                      const void *pval,
                      pj_bool_t keep)
{
    pj_status_t status;
 ...
 */
PJ_DEF(pj_status_t)
pjsua_snd_get_setting(pjmedia_aud_dev_cap cap,
                      void *pval)
{
    pj_status_t status;
 ...
 */
PJ_DEF(pj_status_t)
pjsua_ext_snd_dev_destroy(pjsua_ext_snd_dev *snd)
{
